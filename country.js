...
const BASE_URL = "https://api.freecurrencyapi.com/v1/latest?apikey=${apikey}&base_currency=${fromcurrency}&currencies=${tocurrency}";
...
msg.innerText = `${amVal} ${formCurr.value} = ${finalAmount} ${toCurr.value}`;
